---
title: "QC Notes, Transcriptomics Data, 1st Alignment, Final QC"
output:
  html_notebook:
    toc: yes
...
The limits (coloured lines) correspond to 1MM reads (dark red), mean minus 2 standard dev (0, not whown), mean (118.5MM reads, blue) and mean plus 2 standard deviations (39MM reads, green).
