...
The previous by-sample and by-timepoint results indicate some should be excluded even before going to the analysis of counts.
...
Consideration of the exclusion is deferred until the QC notes on transcriptomic is analysed.
